  ...
  <div class="min-h-screen bg-gray-900 flex flex-col">
    ...
    <main class="flex-1 container mx-auto px-4 py-12">
      <div class="max-w-md mx-auto">
        ...
        <form @submit.prevent="handleRegister" class="bg-gray-800/50 p-8 rounded-2xl border border-gray-700/30 space-y-6">
          <div>
            ...
            <input
                ...
                required
                class="w-full p-3 text-white bg-gray-900 border border-gray-700/30 rounded-xl focus:border-purple-400/50 focus:ring-2 focus:ring-purple-400/20 transition-all"
          ...
          <div>
            <label class="block text-gray-400 mb-2">Название заведения</label>
            <input
                id="name"
                type="text"
          ...
          <div>
            <label class="block text-gray-400 mb-2">Город</label>
            <input
                id="city"
                type="text"
